                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="nama" class="col-4 col-form-label">Gender</label></label>
                                    <div class="col-8">
                                        <input id="gender" name="gender" type="text" class="form-control" value="<?= $row['gender'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="unit_kerja_id" class="col-4 col-form-label">Unit Keja</label>
                                    <div class="col-8">
                                        <?php
